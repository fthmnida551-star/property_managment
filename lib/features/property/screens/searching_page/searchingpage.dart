...
class Searchingpage extends ConsumerWidget {
  ...
  final TextEditingController srchbrcntlr = TextEditingController();
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        ...
        /// ListView is the correct parent for RefreshIndicator
        child: ListView(
          padding: EdgeInsets.all(16.w),
          children: [
            _buildSearchBar(context, ref, userRole),
        ...
        Expanded(
          child: Container(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                border: InputBorder.none,
                prefixIcon: Icon(Icons.search, color: AppColors.opacityGrey),
                hintText: 'Search',
                hintStyle: TextStyle(
                  fontSize: 18.sp,
                  color: AppColors.opacityGrey,
