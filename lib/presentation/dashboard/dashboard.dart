...
import 'package:propertymanagementapp/presentation/dashboard/widget/bookingcontainer.dart';
import 'package:propertymanagementapp/presentation/dashboard/widget/container_widget.dart';
                  ...
                  child: ContainerWidget(
                    child: Padding(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          SvgPicture.asset(AssetResources.booked),
                          SizedBox(height: 5,),
                          Text(
                            'Booked',
                            style: AppTextstyle.propertyMediumTextstyle(
                ...
                ContainerWidget(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        SvgPicture.asset(AssetResources.vacant),
                        SizedBox(height: 5,),
                        Text(
                          'vacant',
                          style: AppTextstyle.propertyMediumTextstyle(
                ...
                child: Row(
                  children: [
                    Padding(
                      ...
                      child: SvgPicture.asset(AssetResources.total),
                    ),
                    Padding(
